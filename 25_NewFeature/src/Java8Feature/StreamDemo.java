...
public class StreamDemo {
	public static void main(String[] args) {
		...
		List<Integer> collect = Stream.iterate(0, n -> n + 1) // For Iterate perpose
		...
		List<Integer> collects = Stream.iterate(0, n -> n + 1) // For Iterate perpose
				.limit(101) // set the maxmium limit
		...
		Integer Temp = Stream.iterate(0, n -> n + 1) // For Iterate perpose
				.limit(101) // set the maxmium limit
				.map(x -> x / 20) // for Conditions
